...
signal margin_call_triggered(trade: Trade, free_margin: float)
signal liquidation_executed(trade: Trade, loss_amount: float)
...
var open_trades: Array[Trade] = []
var closed_trades: Array[Trade] = []
...
## ============================================
func add_trade(trade: Trade) -> bool:
...
## ============================================
func remove_trade(trade: Trade) -> void:
...
func _check_margin_conditions() -> void:
        ...
        for trade in open_trades:
                if trade.is_near_liquidation(0.25) and trade.status != Trade.TradeStatus.MARGIN_CALL:
                        trade.status = Trade.TradeStatus.MARGIN_CALL
...
## ============================================
func close_trade(trade: Trade, reason: String = "يدوي") -> float:
        ...
        trade.status = Trade.TradeStatus.CLOSED
...
## ============================================
func _execute_liquidation(trade: Trade) -> void:
        trade.status = Trade.TradeStatus.LIQUIDATED
        trade.close_time = Time.get_unix_time_from_system()
...
## ============================================
func _get_trades_data(trades: Array[Trade]) -> Array[Dictionary]:
