...
@onready var symbol_label: Label = $VBoxContainer/PriceHeader/SymbolLabel
@onready var price_label: Label = $VBoxContainer/PriceHeader/PriceLabel
@onready var change_label: Label = $VBoxContainer/PriceHeader/ChangeLabel
@onready var chart_panel: Control = $VBoxContainer/ChartPanel/CandlestickChart
@onready var interval_1m: Button = $VBoxContainer/TimeframeBar/Btn1m
@onready var interval_5m: Button = $VBoxContainer/TimeframeBar/Btn5m
@onready var interval_15m: Button = $VBoxContainer/TimeframeBar/Btn15m
@onready var interval_1h: Button = $VBoxContainer/TimeframeBar/Btn1h
@onready var interval_4h: Button = $VBoxContainer/TimeframeBar/Btn4h
@onready var interval_1d: Button = $VBoxContainer/TimeframeBar/Btn1d
